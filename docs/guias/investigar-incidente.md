...
- Que tus aplicaciones ya envíen logs. Si quieres **practicar** con datos de prueba, el dueño del espacio puede ejecutar en **Espacio → Lab** los escenarios **Error agrupado**, **Traza distribuida** y **Pico de incidente** ([Probar con el Lab](probar-con-el-lab.md)).
