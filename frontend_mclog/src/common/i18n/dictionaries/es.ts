...
export const es = {
  ...
  snapshots: {
    ...
    title: "Snapshots",
    description:
      "Copias congeladas de la vista de logs, cada una con su enlace. Quien lo abre ve lo que había al crearlo, aunque después lleguen logs o actúe la retención.",
    share: "Compartir",
    shareHint: "Compartir una copia de esta vista",
    dialogTitle: "Compartir un snapshot",
    dialogDescription: "Se guarda una copia de lo que ves ahora, resumen y tabla, y se crea un enlace para abrirla.",
    titleLabel: "Título",
    titlePlaceholder: "Ej. Caída de facturación del martes",
    visibility: "Quién puede verlo",
    visibilityWorkspace: "Equipo",
    visibilityPublic: "Público",
    visibilityWorkspaceHint: "Solo los miembros de este espacio, con su sesión.",
    visibilityPublicHint: "Cualquiera con el enlace, sin cuenta.",
    publicOwnerOnly: "Solo el dueño del espacio puede crear snapshots públicos.",
    publicDisabled: "Los snapshots públicos están desactivados en la configuración de la plataforma.",
    expiry: "Caduca",
    expiryOptions: { "1": "En 1 día", "7": "En 7 días", "30": "En 30 días", never: "Nunca" },
    rowsAll: (total: string) => `Se guardarán los ${total} logs que cumplen los filtros.`,
    rowsCapped: (saved: string, total: string) =>
      `Se guardarán los primeros ${saved} de ${total} logs, en el orden de la tabla. El resumen cuenta todos.`,
    redactNote:
    ...
    emptyHint: "Crea uno desde Logs o Registros con el botón «Compartir».",
    goToLogs: "Ir a Logs",
    columns: {
      title: "Título",
    ...
    never: "Nunca",
    expired: "Caducado",
    unknownAuthor: "Cuenta borrada",
    remove: "Borrar",
    confirmRemove: "Sí, borrar",
    removeNote: "El enlace deja de funcionar al momento, para todos.",
    removed: "Snapshot borrado",
    removeError: "No pudimos borrar el snapshot",
    viewer: {
      badge: "Snapshot",
      captured: (when: string) => `Capturado el ${when}`,
      expires: (when: string) => `caduca ${when}`,
      redacted: "Datos enmascarados",
      redactedHint:
        "Antes de publicarlo se taparon correos, IPs, tokens, contraseñas y claves. Los IDs de log, las trazas y las huellas se conservan.",
      frozen: "Es una copia congelada: no cambia aunque lleguen logs nuevos.",
      range: "Rango",
      allTime: "Todo el histórico",
      rowsNote: (saved: string, total: string) => `Se guardaron ${saved} de ${total} logs que cumplían los filtros.`,
      summaryNote: "El resumen respeta el rango, la aplicación y el entorno; la tabla, además, el resto de filtros.",
      filterLabels: {
        application: "Aplicación",
        level: "Nivel",
        environment: "Entorno",
      ...
      notFound: "Este snapshot no existe o ha caducado",
      notFoundHint: "Puede que lo hayan borrado, que el enlace esté incompleto o que no tengas acceso a su espacio.",
      signIn: "Inicia sesión para verlo",
      signInHint: "Este snapshot es solo para los miembros de su espacio.",
      ...
      info: {
        apps: "Aplicaciones que enviaron logs en el rango. Debajo, cuántas registraron algún error en ese mismo rango.",
        activity: "Logs por intervalo en el rango capturado, apilados por nivel. Muestra como mucho los últimos 31 días del rango.",
        levelMix: "Reparto de los logs del rango por nivel y, debajo, por entorno.",
        topErrors: "Los 5 fallos distintos con más ocurrencias en el rango, agrupados por huella.",
  ...
  users: {
    ...
    adminHint: "La persona recibirá un enlace para elegir su contraseña. Tú decides si tiene su propio espacio o entra a uno ya existente.",
    mode: "Espacio de trabajo",
    modeOwn: "Espacio propio",
    modeJoin: "Unirse a un espacio",
    ...
    noOwnedWorkspaces: "Aún no hay ningún espacio: crea uno desde el selector de espacios o da a la cuenta un espacio propio.",
    ...
    noWorkspaces: "En ningún espacio",
    openWorkspace: (name: string) => `Abrir los miembros de ${name}`,
  ...
  settings: {
    ...
    keys: {
      ...
      retentionMonths: { label: "Retención de logs", description: "Cuánto tiempo se guardan los logs en la base de datos. Los más antiguos se borran solos cada hora, en todos los espacios. Entre 3 meses y 5 años (60 meses).", unit: "meses" },
      ...
      publicSnapshotsEnabled: { label: "Snapshots públicos", description: "Enlaces que se abren sin cuenta. Apagado, no se pueden crear y los que ya existen dejan de abrirse hasta volver a encenderlo." },
  ...
  fieldInfo: {
    ...
    users: {
      ...
      role: "• Usuario: una cuenta normal.\n• Admin de plataforma: administra la aplicación entera: gestiona las cuentas y es dueño de todos los espacios.",
      mode: "• Espacio propio: la cuenta estrena un espacio vacío del que es dueña.\n• Unirse a un espacio: entra a un espacio existente y ve sus logs.",
    },
    ...
    /** Snapshots: el dialogo de compartir. */
    snapshots: {
      title: "Cómo aparecerá en la lista de Snapshots y en la cabecera del enlace. Ponle algo que diga qué se está enseñando.",
      visibility:
        "Equipo: solo los miembros de este espacio, con su sesión; si alguien sale del espacio, deja de verlo.\nPúblico: cualquiera con el enlace, sin cuenta. Se enmascaran los datos sensibles y no se muestra el nombre del espacio.",
      expiry: "Pasada la fecha el enlace deja de funcionar y la copia se borra. «Nunca» la guarda hasta que alguien la borre.",
    },
  },
