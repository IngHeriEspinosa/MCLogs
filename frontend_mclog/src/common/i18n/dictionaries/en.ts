...
export const en: Dictionary = {
  ...
  users: {
    ...
    adminHint: "The person will get a link to choose their password. You decide whether they get their own workspace or join an existing one.",
    mode: "Workspace",
    modeOwn: "Own workspace",
    modeJoin: "Join a workspace",
    workspaceName: "Workspace name",
    workspaceNamePlaceholder: (email: string) => (email ? `${email.split("@")[0]}'s workspace` : "e.g. Acme client"),
    joinWorkspace: "Workspace",
    workspaceRole: "Workspace role",
    noOwnedWorkspaces: "There are no workspaces yet: create one from the workspace switcher or give the account its own workspace.",
    ...
    noWorkspaces: "In no workspace",
    openWorkspace: (name: string) => `Open the members of ${name}`,
  ...
  settings: {
    ...
    keys: {
      ...
      retentionMonths: { label: "Log retention", description: "How long logs are kept in the database. Older ones are deleted automatically every hour, in every workspace. Between 3 months and 5 years (60 months).", unit: "months" },
  ...
  fieldInfo: {
    ...
    users: {
      ...
      role: "• User: a regular account.\n• Platform admin: manages the whole application: the accounts, and every workspace as its owner.",
      mode: "• Own workspace: the account starts with an empty workspace it owns.\n• Join a workspace: it joins an existing workspace and sees its logs.",
    },
